...
path2scripts = '/home/lauren/TensorFlow/models/research/' # TODO: provide pass to the research folder
...
path2config ='/home/lauren/TensorFlow/penguin_detection_model/exported_models/eff_det_4/pipeline.config'
path2model = '/home/lauren/TensorFlow/penguin_detection_model/exported_models/eff_det_4/checkpoint'
...
path2label_map = '/home/lauren/TensorFlow/penguin_detection_model/training/object-detection.pbtxt' # TODO: provide a path to the label map file
...
def inference_with_plot(image_np, box_th=0.25):
    """
...
def inference_as_raw_output(image_np,
                            box_th = 0.25,
                            nms_th = 0.5,
                            to_file = True,
                            data = "penguin",
    ...
    if to_file and data: # if saving to txt file was requested
        ...
        line2write = list()
        line2write.append(os.path.basename('/home/lauren/TensorFlow/penguin_detection_model'))
...
def get_jpg():
    import cv2
    vidcap = cv2.VideoCapture('/media/lauren/9CE2-B257/R0010003_st.MP4')
    ...
    while success:
        ...
        inference_with_plot(image)
        com_list = inference_as_raw_output(image)
        #print(image)
        count += 1
...
def main():
    get_jpg()
    #path2images = {'/home/lauren/TensorFlow/penguin_detection_model/images/R0010003_st_Moment.jpg'}
